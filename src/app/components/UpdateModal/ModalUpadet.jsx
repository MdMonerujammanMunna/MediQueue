...
export function ModalUpadate({ name }) {
                            ...
                            <Fieldset className="w-full">
                                <Fieldset.Group>
                                    ...
                                    <div className="flex items-center gap-5">
                                        {/* Fee section */}
                                        <TextField className={"flex-1"} name="Fee" type="number">
                                            <Label>Hourly fee</Label>
                                            <Input placeholder="$75" variant="secondary" type="number" />
                                            <FieldError />
                                        </TextField>
                                        {/* Slot section*/}
                                        <TextField className={"flex-1"} name="Slot" type="number">
                                    ...
                                    {/* SessionDate section */}
                                    <div className="">
                                        <TextField name="SessionDate" type="date" >
